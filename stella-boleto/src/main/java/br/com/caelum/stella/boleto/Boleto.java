...
public class Boleto implements Serializable {
    ...
    protected List<String> instrucoesFichaCompensacao = Collections.emptyList();
    protected List<String> instrucoesReciboPagador = Collections.emptyList();
    ...
    /**
     * @return lista de instruções da Ficha de compensação do boleto
     */
    public List<String> getInstrucoesFichaCompensacao() {
        return this.instrucoesFichaCompensacao;
    }

    /**
     * @param instrucoesFichaCompensacao que serão associadas ao boleto (limite de 14)
     * @return este boleto
     * @throws IllegalArgumentException caso tenha mais de 12 instruções
     */
    public Boleto comInstrucoesFichaCompensacao(String... instrucoesFichaCompensacao) {
        if (instrucoesFichaCompensacao.length > 12) {
            throw new IllegalArgumentException("maximo de 12 instrucoesFichaCompensacao permitidas");
        }
        this.instrucoesFichaCompensacao = Arrays.asList(instrucoesFichaCompensacao);
        return this;
    }
     ...
     */
    public List<String> getInstrucoesReciboPagador() {
        return this.instrucoesReciboPagador;
    }

    /**
     * @param instrucoesReciboPagador que serão associadas ao boleto (limite de 7)
     * @return este boleto
     * @throws IllegalArgumentException caso tenha mais de 7 instruções
     */
    public Boleto comInstrucoesReciboPagador(String... instrucoesReciboPagador) {
        if (instrucoesReciboPagador.length > 7) {
            throw new IllegalArgumentException("maximo de 7 instrucoesFichaCompensacao permitidas");
        }
        this.instrucoesReciboPagador = Arrays.asList(instrucoesReciboPagador);
        return this;
    }
